...
function ContextMenuSubTrigger({
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center rounded-xl px-2.5 py-2 text-sm outline-hidden select-none transition-colors focus:bg-[#EEF3FF] focus:text-[#111B4D] data-[state=open]:bg-[#EEF3FF] data-[state=open]:text-[#111B4D] data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
