...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn(
        "flex h-10 items-center gap-1 rounded-2xl border border-[#E3E8F2] bg-white/80 p-1 shadow-sm backdrop-blur",
        className
      )}
      {...props}
    />
  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[12rem] origin-(--radix-menubar-content-transform-origin) overflow-hidden rounded-2xl border border-[#E3E8F2] bg-white/96 p-1.5 text-popover-foreground shadow-[0_24px_70px_rgba(30,42,120,0.18)] backdrop-blur-xl data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
          className
        )}
        {...props}
      />
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2.5 py-2 text-xs font-bold uppercase tracking-wide text-slate-500 data-[inset]:pl-8",
        className
      )}
      {...props}
    />
