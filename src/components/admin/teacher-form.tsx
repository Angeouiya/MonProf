...
const schema = z.object({
  ...
  offersFrenchSystem: z.boolean().default(false),
  offersProfessionalTraining: z.boolean().default(false),
  ...
  const { register, handleSubmit, control, setValue, getValues, formState: { errors } } = useForm<FormValues>({
    ...
    defaultValues: initial
      ? {
          ...
          offersFrenchSystem: initial.offersFrenchSystem ?? false,
          offersProfessionalTraining: initial.offersProfessionalTraining ?? false,
        }
      : {
          ...
          offersFrenchSystem: false,
          offersProfessionalTraining: false,
