            ...
            <section key={day.key} className="rounded-[1.15rem] border border-[#E6EAF3] bg-white p-3">
              <div className="mb-3 flex items-start justify-between gap-3">
                ...
                <div className="flex gap-1.5">
                  <Button type="button" variant="outline" size="sm" className="rounded-xl bg-white px-2 text-[11px]" onClick={() => setDay(day.key, true)}>Tout</Button>
                  <Button type="button" variant="ghost" size="sm" className="rounded-xl bg-white px-2 text-[11px]" onClick={() => setDay(day.key, false)}>Vider</Button>
                </div>
              </div>
