...
export function PaymentMethodLogo({ method, className }: PaymentMethodLogoProps) {
  ...
  if (method === "WAVE") {
    return (
      <span className={cn("inline-flex h-11 min-w-24 items-center justify-center overflow-hidden rounded-2xl border border-[#E3E8F2] bg-[#26BCEB] px-2 shadow-sm", className)} aria-label={label}>
        <Image
  ...
  if (method === "ORANGE_MONEY") {
    return (
      <span className={cn("inline-flex h-11 min-w-24 items-center justify-center rounded-2xl border border-[#E3E8F2] bg-white px-3 shadow-sm", className)} aria-label={label}>
  ...
  if (method === "MOOV_MONEY") {
    return (
      <span className={cn("inline-flex h-11 min-w-24 items-center justify-center rounded-2xl border border-[#E3E8F2] bg-white px-2 shadow-sm", className)} aria-label={label}>
        <Image
