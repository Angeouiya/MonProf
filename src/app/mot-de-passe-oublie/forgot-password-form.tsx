...
export function ForgotPasswordForm() {
  ...
  return (
    <form onSubmit={submit} className="mt-5 space-y-4">
      ...
      {sent && (
        <div className="rounded-2xl border border-[#DDE6F7] bg-white p-3 text-sm font-semibold leading-6 text-[#111B4D]">
      ...
      <Button type="submit" disabled={loading} className="min-h-11 w-full rounded-2xl bg-[#111B4D] text-white hover:bg-[#1E2A78]">
