      ...
      const res = await fetch("/api/admin/teacher-notifications", {
        ...
        body: JSON.stringify({
          ...
          message: [
            ...
            `Motif : ${reason}`,
            "",
            "Merci de répondre rapidement au service client avec votre version des faits et tout élément utile.",
          ].join("\n"),
        }),
      });
      ...
      const res = await fetch("/api/admin/client-communications", {
        ...
        body: JSON.stringify({
          ...
          content: [
            ...
            `Cours : ${booking.subjectName} - ${booking.levelName}`,
            "",
            "Le service client vérifie les éléments avec le professeur. Votre paiement reste sécurisé pendant le traitement.",
