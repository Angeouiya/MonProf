...
export function ClientPasswordSettingsForm() {
  ...
  return (
    <form onSubmit={submit} data-client-account-form className="client-account-form mt-4 grid gap-3">
      ...
      <div data-client-password-rules className="grid gap-2 rounded-lg border border-[#E3E8F2] bg-white p-2.5 text-xs font-semibold leading-5 text-[#64748B] min-[760px]:grid-cols-3">
        {rules.map((rule) => (
