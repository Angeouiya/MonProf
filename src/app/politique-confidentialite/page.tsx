...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Données partenariat : nom et téléphone de l'apporteur déclaré par un client, réservation concernée, période de promotion, statut de validation, montant du cours, commission calculée, preuve d'identité éventuellement fournie, moyen de dépôt, référence de paiement et notes de vérification administratives.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Gérer le programme partenariat temporaire : enregistrer une déclaration faite pendant la réservation, calculer la commission hors transport et frais, vérifier l'identité de l'apporteur, refuser les réclamations tardives ou frauduleuses et tracer le dépôt éventuel.",
