...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Données de réservation : professeur choisi, matière, niveau, date, heure, format, lieu, tarif, nombre de participants, règles d'annulation, confirmations, statuts, demandes d'alternative professeur et réponses aux propositions de remplacement.",
      ...
      "Données de paiement : montant payé, frais liés au moyen de paiement, boutique ou marchand Jèko affiché, référence Jèko ou référence historique, statut serveur vérifié, statut webhook, montant remboursable, numéro de remboursement si le client le fournit.",
      "Données partenariat : nom, téléphone et email facultatif de l'apporteur, client annoncé, code ou lien de recommandation, réservation concernée, période de promotion, statut de validation, montant du cours, commission calculée, preuve d'identité demandée ou fournie, moyen de dépôt, référence de paiement et notes de vérification administratives.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Jèko traite les informations strictement nécessaires aux nouveaux paiements et aux retraits professeurs ; la boutique ou le marchand attendu doit correspondre à Compétence.CI ou à la Boutique Compétence. Une boutique tierce ou un marchand inattendu ne doit pas être utilisée pour valider un paiement Compétence. Les anciens dossiers de paiement restent conservés uniquement pour l'historique, l'audit et les obligations légales.",
  ...
  },
  {
    ...
    body: [
      ...
      "Les déclarations partenariat non confirmées expirent à la fin de la période promotionnelle. Les déclarations payées, rejetées ou liées à un litige financier sont conservées aussi longtemps que nécessaire à la preuve, à la comptabilité interne et à la prévention de la fraude.",
