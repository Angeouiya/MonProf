        ...
        {notifications.length === 0 ? (
          ...
          <div className="grid gap-3">
            {notifications.map((notification) => (
              <article key={notification.id} className="rounded-[1.15rem] border border-[#E6EAF3] bg-white p-4 shadow-sm">
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-2 border-t border-[#EEF2F7] pt-3 text-xs font-semibold text-[#64748B]">
                  ...
                  {notification.bookingId && (
                    <Link
                      ...
                      className="inline-flex min-h-10 items-center justify-center rounded-xl border border-[#D7DEE9] bg-white px-3 font-semibold text-[#111B4D] shadow-sm transition hover:border-[#111B4D]"
                    >
