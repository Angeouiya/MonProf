            ...
            <div className="grid gap-3">
              {verifiedUpcomingBookings.map((booking) => (
                <Link
                  ...
                  className="grid gap-3 rounded-[1.15rem] border border-[#E6EAF3] bg-white p-4 shadow-sm transition hover:border-[#111B4D] sm:grid-cols-[1fr_auto] sm:items-center"
                >
                  <div>
...
function ProfessorControlStep({
  ...
  return (
    <Link
      href={href}
      className={urgent
        ? "group rounded-[1.05rem] border border-[#111B4D] bg-white p-3 shadow-sm transition hover:border-[#111827]"
        : "group rounded-[1.05rem] border border-[#E6EAF3] bg-white p-3 shadow-sm transition hover:border-[#111B4D]"
      }
    >
...
function ProfessorQuickLink({
  ...
  return (
    <Link
      href={href}
      className="group flex min-h-[4.45rem] flex-col justify-between rounded-xl border border-[#E6EAF3] bg-white px-2.5 py-2.5 shadow-sm transition hover:border-[#111B4D] sm:px-3 sm:py-3"
    >
...
function ProfessorActionTile({
  ...
  return (
    <Link
      href={href}
      className="group grid min-h-40 gap-4 rounded-[1.15rem] border border-[#E6EAF3] bg-white p-4 shadow-sm transition hover:border-[#111B4D]"
    >
      <div className="flex items-start justify-between gap-3">
