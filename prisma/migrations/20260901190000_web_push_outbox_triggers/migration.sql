-- Every internal notification must create a durable Web Push outbox row.
-- The trigger keeps transactional writes covered, including writes made with
-- Prisma transaction clients that cannot publish to Cloudflare Queues directly.
